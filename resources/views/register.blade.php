...
<html lang="en">
    ...
    <body>
        ...
        <img src="images/logo.png" style="width:1500px; height:1200px;margin-left:0px;margin-top:-180px;position:absolute;opacity:0.3;">
            <h1><u>WELCOME!</u></h1>
        <div class="box" align="center" style="position:relative;">
            <div class="content">
                ...
                <form>
                    ...
                    <br><br><br>
                    <div class="account">Have an account? <a href="/login" ><u>Login now!</u></a></div>
                </form>
            </div>
        </div>
    </center>
