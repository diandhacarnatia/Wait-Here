...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/struk.css">
    ...
    <body>
        ...
        <br><br><br><h1><u>RESERVATION RECEIPT</u></h1>
        ...
        <div class="box" align="center"style="position:relative;">
            <div class="content" align="left" style="padding-left:50px;">
                ...
                <form >
                    <table>
                        <tr>
                            <td><label class="nama" for="nama">Nama Pelanggan  </label></td>
                            <td><textarea readonly></textarea></td>
                        </tr>
                        <tr>
                            <td><label class="judul" for="npm">Nama Restoran  </label></td>
                            <td><textarea readonly></textarea></td>
                        </tr>
                        <tr>
                            <td><label class="judul" for="alamat">Jumlah Pengunjung &#160 </label></td>
                            <td><textarea readonly></textarea></td>
                        </tr>
                        <tr>
                            <td><label class="judul" for="prodi">Tanggal Reservasi  </label></td>
                            <td><textarea readonly></textarea></td>
                        </tr>
                        <tr>
                            <td><label class="judul" for="tmpt">Waktu Reservasi</label></td>
                            <td><textarea readonly></textarea></td>
                        </tr>
                    </table>
                </form>
