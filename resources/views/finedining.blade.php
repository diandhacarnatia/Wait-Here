  ...
  <style>
    ...
    <body>
        ...
        <div class=container>
            <div class="row" style="text-align:left;">
            <div class="col-sm-3">
                <img src="images/fd_amuz.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
            </div>
            <div class="col-sm-6">
                ...
                <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Monday - Saturday</a>
                <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 17.00 - 21.00</a>
        ...
        <div class="resto2" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/fd_namaaz.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        Namaaz Dining
        ...
        <div class="resto3" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/fd_henshin.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        HENSHIN
                    </div> <br>
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Monday - Sunday</a>
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 16.00 - 23.00</a>
                    <div class="row" style="margin-top: 20px; margin-left: 240px;">
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
