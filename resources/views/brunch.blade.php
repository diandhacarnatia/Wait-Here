  ...
  <style>
    ...
    <body>
        ...
        <div class=container>
            <div class="row" style="text-align:left;">
            <div class="col-sm-3">
                <img src="images/brunch_union.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
            </div>
            <div class="col-sm-6">
        ...
        <div class="resto2" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/brunch_pippo.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        PIPPO
        ...
        <div class="resto3" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/brunch_sel.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        SEL GUNAWARMAN
