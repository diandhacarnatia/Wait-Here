  ...
  <style>
    ...
    <body>
        ...
        <div class=container>
            <div class="row" style="text-align:left;">
            <div class="col-sm-3">
                <img src="images/bvg_honu.png" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
            </div>
            <div class="col-sm-6">
        ...
        <div class="resto2" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/bvg_tuku.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        TOKO KOPI TUKU
                    ...
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Senin - Minggu</a>
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 08.00 - 22.00</a>
                    <div class="row" style="margin-top: 20px; margin-left: 240px;">
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
        ...
        <div class="resto3" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/bvg_gooma.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        GOOMA TEA BAR
            ...
            <div class="resto4" style="height: 70;">
                <div class=container>
                    <div class="row" style="text-align:left;">
                    <div class="col-sm-3">
                        <img src="images/bvg_kokumi.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                    </div>
                    <div class="col-sm-6">
                        <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                            KOKUMI
                        ...
                        <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Senin - Minggu</a>
                        <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 10.00 - 20.00</a>
                        <div class="row" style="margin-top: 20px; margin-left: 240px;">
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
