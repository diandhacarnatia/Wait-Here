  ...
  <style>
    ...
    <body>
        ...
        <div class=container>
            <div class="row" style="text-align:left;">
            <div class="col-sm-3">
                <img src="images/ff_threebuns.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
            </div>
            <div class="col-sm-6">
                ...
                <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 09.00 - 21.00</a>
        ...
        <div class="resto2" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/ff_pepperlunch.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
        ...
        <div class="resto3" style="height: 70;">
            <div class=container>
                <div class="row" style="text-align:left;">
                <div class="col-sm-3">
                    <img src="images/ff_tacobell.jpeg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                </div>
                <div class="col-sm-6">
                    <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                        TACO BELL
                    ...
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Senin - Minggu</a>
                    <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 11.00 - 20.00</a>
                    <div class="row" style="margin-top: 20px; margin-left: 240px;">
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                        <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
            ...
            <div class="resto4" style="height: 70;">
                <div class=container>
                    <div class="row" style="text-align:left;">
                    <div class="col-sm-3">
                        <img src="images/ff_mcd.jpg" style="text-align:left; width:300px; height:290px;margin-top:30px;margin-left:70px;box-shadow: 5px 4px 3px #8E9775;border-radius:10px;">
                    </div>
                    <div class="col-sm-6">
                        <div style="width: 700px; height: 45px; background-color:#e28f83;color:#4a503d; text-align: center; padding-top: 7px; margin-left: 200px; box-shadow: 5px 4px 3px #8E9775;border-radius:10px; font-size:23px; letter-spacing: 10px;">
                            MCDONALD'S
                        ...
                        <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> Senin - Minggu</a>
                        <a style="color:#4a503d; margin-left: 250px; font-size: 20px; letter-spacing: 7px;"> 07.00 - 23.00</a>
                        <div class="row" style="margin-top: 20px; margin-left: 240px;">
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
                            <i class="fas fa-star fa-3x" style="color:#ba9b4a; "></i>
